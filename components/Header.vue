      ...
      <div class="row">
        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
          <div class="header_contact text-right">
            <ul class="hd_contact">
              <li><i class="icon-placeholder"></i> Address<a href=""> 8215 Ulmerton Rd, Largo, FL 33771</a></li>
              <li><i class="icon-phone-call"></i> Call Now<a href=""> 727 275 0543</a></li>
              <li><i class="icon-clock"></i> Open Hours<a href=""> Mon-fri: 9am - 6pm</a></li>
            </ul>
            ...
            <div class="collapse navbar-collapse remove_padding" id="myNavbar">
              <ul class="nav navbar-nav text-center">
                ...
                <li class="header_right_btn">
                  <a class="btn-yellow" href="#">EASY FINANCING APPLY NOW!</a>
                </li>
              </ul>
            </div><!--end .collapse-->
          </div><!--end .col-md-10-->
